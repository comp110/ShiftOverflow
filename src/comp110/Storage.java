...
public class Storage {
    ...
    public String get_availability_csv_filename_from_onyen(String onyen){
        return this.m_application_directory + DEFAULT_LOCAL_REPO_FOLDER + "/data/fall-18/staff/" + onyen + ".csv";
    }
    ...
    public String get_path_to_onyen_csv_directory(){
        return this.m_application_directory + DEFAULT_LOCAL_REPO_FOLDER + "/data/fall-18/staff/";
    }
